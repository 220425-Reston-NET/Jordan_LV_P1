...
namespace StoreDL
{
    ...
    public class StoreItemRepository : IRepository<StoreItem>
    {
        ...
        void IRepository<StoreItem>.Add(StoreItem p_resource)
        {
            throw new NotImplementedException();
        }

        List<StoreItem> IRepository<StoreItem>.GetAll()
        {
            throw new NotImplementedException();
        }

        Task<List<Customer>> IRepository<StoreItem>.GetAllAsync()
        {
            throw new NotImplementedException();
        }

        void IRepository<StoreItem>.Update(StoreItem p_resource)
        {
            throw new NotImplementedException();
        }
    }
