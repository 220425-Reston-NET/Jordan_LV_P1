...
// {
//     private string _filepath = "./Data/StoreDL.json";
...
//         */
//         string jsonString = JsonSerializer.Serialize(Itemobj, new JsonSerializerOptions(){WriteIndented = true});
...
//             StoreDL storeobj2 = JsonSerializer.Deserialize<StoreDL>(jsonString2);
//             Console.WriteLine(storeobj2.Brand);
            
//         }
//         //FileNotFoundException means that the Car.json doesn't exist and it tried reading it
//         catch (FileNotFoundException)
//         {
//             StoreDL obj3 = new StoreDL();
//             string jsonString3 = JsonSerializer.Serialize(storeobj3);
